...
public:
  ...
  TonlibWorkerResponse process_getTransactions(td::Result<tonlib_api::raw_getTransactionsV2::ReturnType>&& res, bool v2_schema = true, bool unwrap_single_transaction = false) const;
};
}
